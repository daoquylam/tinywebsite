		...
		<div class="container margin_60_35">
			<div class="row">
				<div class="col-lg-5 col-md-12 p-r-5">
					<p><img src="<?php echo public_url();?>/site/img/logo.png" width="150" height="36" data-retina="true" alt=""></p>
					<p>Là đơn vị hàng đầu trong ngành cung cấp gỗ nguyên liệu và sản phẩm đồ gỗ nội thất. Chúng tôi tự hào cung cấp những sản phẩm chất lượng mang lại sự hài lòng cho các bạn.</p>
					<div class="follow_us">
						<ul>
							<li>Follow us</li>
				...
				<div class="col-lg-3 col-md-6 ml-lg-auto">
					...
					<ul class="links">
						...
						<li><a href="blog.html">Gỗ Nguyên Liệu</a></li>
			...
			<div class="row">
				<div class="col-lg-6">
					<ul id="footer-selector">
						...
						<li><img src="<?php echo public_url();?>/site/img/cards_all.svg" alt=""></li>
					</ul>
				</div>
				<div class="col-lg-6">
